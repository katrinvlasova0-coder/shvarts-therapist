    ...
    <section id="amalgam" ref={ref} className="relative bg-void overflow-hidden py-24 md:py-40 px-5 md:px-10">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto">
        <div className={`reveal ${visible ? 'is-visible' : ''}`}>
          <h2
            className="text-bone font-black tracking-mega leading-[0.85] whitespace-nowrap"
            style={{ fontSize: 'clamp(1.1rem, 6vw, 6rem)' }}
          >
            {en ? 'THE AUTHOR’S METHOD:' : 'АВТОРСКИЙ МЕТОД:'}
          </h2>
          <h3
            className="mt-2 gold-shimmer font-black tracking-mega leading-[0.82]"
            style={{ fontSize: 'clamp(2.5rem, 11vw, 10rem)' }}
          >
            {en ? 'AMALGAMA' : 'АМАЛЬГАМА'}
          </h3>
        </div>
